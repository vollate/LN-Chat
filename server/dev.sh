...
BUILD_CMD="cmake -GNinja -DCMAKE_PREFIX_PATH=$VCPKG_ROOT/installed/x64-linux -DCMAKE_CXX_COMPILER=$CXX -DCMAKE_TOOLCHAIN_FILE=$VCPKG_TOOLCHAIN -DCMAKE_BUILD_TYPE="
if [ $# -eq 0 ]
then
