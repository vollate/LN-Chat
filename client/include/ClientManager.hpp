...
public:
    ...
    ~ClientManager();
    Q_INVOKABLE bool createRoom(QString name, QString passWord, ServerManager* serverManager);
    Q_INVOKABLE bool joinRoom(QString name, QString password, ServerManager* serverManager);
